...
if __name__ == '__main__':
    ...
    sample.download_blob_to_file(blob_service_client)
    sample.download_blob_to_stream(blob_service_client)
    sample.download_blob_to_string(blob_service_client)
    sample.download_blob_from_stream(blob_service_client)
